...
<%
	...
	String likeProductId = request.getParameter("likeProductId");
...
//------
	...
	try{
        ...
        String A = "delete from liked where likeUserId = '"+userId+"' and likeProductId = ?";
	
	
	    ps = conn_mysql.prepareStatement(A);
	    ps.setString(1, likeProductId);
